                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale" data-id="{{ $all->id }}" data-section_name="{{ $all->section_name }}" data-description="{{ $all->description }}" data-toggle="modal" href="#exampleModal2" title="تعديل"><i class="las la-pen"></i>
                                    </a>
                                    <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale" data-id="{{ $all->id }}" data-section_name="{{ $all->section_name }}" data-toggle="modal" href="#modaldemo9" title="حذف"><i class="las la-trash"></i>
                                    </a>
                                </td>
                            </tr>
                            @endforeach
...
<div class="modal" id="modaldemo9">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <form action="{{ route('sections.delete') }}">
                @method('DELETE')
                @csrf
                <div class="modal-body">
