                                            ...
                                            <table class="table table-striped" style="text-align:center">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <th scope="row">تاريخ الإستحقاق</th>
                                                        <td>{{ $invoices->Due_date }}</td>
                                                        <th scope="row">القسم</th>
                                                        <td>{{ $invoices->sections->section_name }}</a></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="badge badge-pill badge-success">{{ $invoices->Status }}</span>
                                                        </td>
                                                        @elseif($invoices->Value_Status ==2)
                                                        <td><span class="badge badge-pill badge-danger">{{ $invoices->Status }}</span>
                                                        </td>
                                                        @else
                                                        <td><span class="badge badge-pill badge-warning">{{ $invoices->Status }}</span>
                                                        </td>
                                                        @endif
                                                    </tr>
                                    ...
                                    <div class="tab-pane" id="tab6">
                                        ...
                                        <div class="card card-statistics">
                                            <div class="card-body">
                                                ...
                                                <form method="POST" action="{{ url('/InvoicesAttachments/store') }}" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                ...
                                                                <a class="btn btn-outline-success btn-sm" href="{{ url('View_file') }}/{{ $invoices->invoice_number }}/{{ $attachment->file_name }}" role="button"><i class="fas fa-eye"></i>&nbsp; عرض</a>

                                                                <a class="btn btn-outline-info btn-sm" href="{{ url('download') }}/{{ $invoices->invoice_number }}/{{ $attachment->file_name }}" role="button"><i class="fas fa-download"></i>&nbsp; تحميل</a>
